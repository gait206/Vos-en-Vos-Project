        ...
        <div class="navigator">
           ...
           <div class="navigatie">
                <form action="" method="get" id="select">
                    ...
                    <input type="checkbox"  name="subcategorie[]"  value="Afvalzakken" <?php if (in_array("Afvalzakken", $subcategorie)) echo "checked ='checked'"; ?> onclick="this.form.submit()";>Afvalzakken<br>
                    <input type="checkbox"  name="subcategorie[]"  value="Doseerapparaten" <?php if (in_array("Doseerapparaten", $subcategorie)) echo "checked ='checked'"; ?> onclick="this.form.submit()";>Doseerapparaten<br><br>
