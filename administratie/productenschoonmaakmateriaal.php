        ...
        <div class="navigator">
           ...
           <div class="navigatie">
                <form action="" method="get" id="select">
                    ...
                    <input type="checkbox"  name="subcategorie[]"  value="Afvalzakken" <?php 
					// houdt de checkbox gechecked, ook nadat de pagina is herladen
					if (in_array("Afvalzakken", $subcategorie)) echo "checked ='checked'"; ?> onclick="this.form.submit()";>Afvalzakken<br>
